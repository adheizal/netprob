...
- Save ping and complete MTR results in SQLite. When VictoriaMetrics is configured, mirror enriched ping metrics, bounded MTR summaries, failed-ping status, and periodic controller inventory without putting error text or individual MTR hops into labels.
